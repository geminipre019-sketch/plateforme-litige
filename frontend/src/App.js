...
const CardIcon = () => ( <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2.5 1a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1h-1zm-1 3a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1H1.5z"/></svg> );
...
2.  Envoyez les modifications sur GitHub avec les commandes :
    ...
    ```
    ```bash
    git commit -m "Fix syntax error and add separate CB popup button"
    ```
    ```bash
    git push
